...
class Anuncios extends model
{
    ...
    public function addAnuncio($id_usuario, $titulo, $categoria, $valor, $descricao, $estado) {
        ...
        $sql = $this->db->prepare("INSERT INTO anuncios SET id_usuario = :id_usuario, titulo = :titulo, id_categoria = :id_categoria, valor = :valor, descricao = :descricao, estado = :estado");
    ...
    public function editAnuncio($id, $id_usuario, $titulo, $categoria, $valor, $descricao, $estado, $fotos) {
        ...
        $sql = $this->db->prepare("UPDATE anuncios SET id = :id, id_usuario = :id_usuario, titulo = :titulo, id_categoria = :id_categoria, valor = :valor, descricao = :descricao, estado = :estado 
                                    WHERE id = :id");
        $sql->bindValue(":id", $id);
        $sql->bindValue(":id_usuario", $id_usuario);
        $sql->bindValue(":titulo", $titulo);
    ...
    public function getTotalAnuncios($filtros) {
        $sql = $this->db->prepare("SELECT COUNT(*) as c FROM anuncios WHERE " . implode(' AND ', $this->trataFiltros($filtros)));
